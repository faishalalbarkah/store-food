          ...
          <div class="row">
            <div class="col-12 col-lg-8">
              <ul class="list-unstyled">
                <li class="media">
                  <img src={{url("./images/Product-Details/Icon-Testimoni/1.png")}}
                  alt=""
                ...
                <li class="media">
                  <img src={{url("./images/Product-Details/Icon-Testimoni/2.png")}}
                  alt=""
                  class="mr-3 rounded-circle"
                  >
                  <div class="media-body">
                    <h5 class="mt-2 mb-1">Anna Sukiratna</h5>
                ...
                <li class="media">
                  <img src={{url("./images/Product-Details/Icon-Testimoni/3.png")}}
                  alt=""
                  class="mr-3 rounded-circle"
                  >
                  <div class="media-body">
