            ...
            <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="zip_code" name="zip_code" value="85965896">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phone_number" name="phone_number" value="+62 859 2536 8596">
                  </div>
                </div>
