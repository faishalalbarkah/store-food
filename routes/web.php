...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/dashboard/products/details/{id}', 'DashboardProductController@details')->name('dashboard-product-details');
    ...
    Route::post('/dashboard/products/details/{id}', 'DashboardProductController@update')->name('dashboard-product-update');
    Route::get('/dashboard/products/details/gallery/delete/{id}', 'DashboardProductController@deleteGallery')->name('dashboard-product-gallery-delete');
...
Route::prefix('adpanel')->namespace('Admin')->middleware(['auth','admin'])->group(function() {
